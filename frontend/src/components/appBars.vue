<template>
    <v-layout>
        ...
        <v-bottom-navigation grow>
            <v-btn value="panel" :active="route.name == 'chart'" @click="toPage('/chart')">
                <v-icon>mdi-history</v-icon>
                图表
            </v-btn>

            <v-btn value="log" :active="route.name == 'logs'" @click="toPage('/logs')">
            ...
            <v-btn value="config" :active="route.name == 'setting'" @click="toPage('/setting')">
